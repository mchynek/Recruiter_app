...
<div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
    <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
        ...
        <div class="p-3">
            <form:form method="get" modelAttribute="candidateList"/>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <button class="bg-transparent hover:bg-green-500 text-green-dark font-semibold hover:text-white py-2 px-4 border border-blue hover:border-transparent rounded">
                                <a href="/candidate/massages/list?candidateId=${candidate.id}"/>
<%--                                lista wiadomości--%>
                                Wiadomości
                            </button>
                        </td>
                        ...
                        <td class="border px-4 py-2">
                            <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white inline-block" href="/candidate/addToProject?idToAdd=${candidate.id}">
                                <i>Dodaj do projektu</i></a>
                            <a href="/candidate/view?candidateId=${candidate.id}" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
                            ...
                            <a href="/candidate/delete?idToDelete=${candidate.id}" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-red-500 inline-block">
